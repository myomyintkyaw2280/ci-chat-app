 		...
 		?>
        	<?php
            	...
            	if($message=='NULL'){ //fetach media objects like images,pdf,documents etc
				  ...
				  if($mime_type[0]=='image'){
 					$messageBody.='<img src="'.$document_url.'" onClick="ViewAttachmentImage('."'".$document_url."'".','."'".$attachment_name."'".');" class="attachmentImgCls" style="width:50%;">';	
				  }else{
					$messageBody='';
             ...
             <?php if($Logged_sender_id!=$sender_id){?>     
                  <!-- Message. Default to the left -->
                    <div class="direct-chat-msg" >
                      ...
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text" style="margin-right:8rem;">
                         <?=$messageBody;?>
                      </div>
                      <!-- /.direct-chat-text -->
			...
			<?php }else{?>
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <img class="direct-chat-img" src="<?=$userPic;?>" alt="<?=$userName;?>">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text"  style="margin-left:8rem;">
                      	<?=$messageBody;?>
                          	<!--<div class="spiner">
